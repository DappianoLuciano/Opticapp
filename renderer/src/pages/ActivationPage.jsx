...
const MODULE_LABELS = {
  ...
  pacientes:  "Pacientes",
  recetas:    "Recetas",
  inventario: "Inventario + Proveedores",
  finanzas:   "Ventas, Caja, Balance, Gastos",
};
  ...
  return (
    <div style={styles.overlay}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Activación de licencia</p>

        <p style={styles.description}>
          Ingresá el código de licencia para activar la aplicación.
        </p>
...
export function BlockedPage() {
  return (
    <div style={styles.overlay}>
      <div style={styles.card}>
        <div style={styles.logo}>OpticApp</div>
        <p style={styles.subtitle}>Licencia vencida</p>
        <p style={styles.description}>
          La licencia de este equipo ha vencido.<br />
          Contactate con soporte para renovarla.
        </p>
        <div style={{ fontSize: 14, color: "var(--text)", lineHeight: 2.2, textAlign: "center" }}>
          <div style={{ fontWeight: 800 }}>soporte@opticapp.com.ar</div>
          <div style={{ opacity: 0.6, fontSize: 13 }}>Respondemos en menos de 24 hs</div>
        </div>
      </div>
    </div>
  );
...
const styles = {
  ...
  subtitle: {
    fontSize: 13, color: "var(--muted, rgba(15,23,42,0.65))", margin: "0 0 24px",
  },
  description: {
    fontSize: 14, color: "var(--text, #0f172a)",
